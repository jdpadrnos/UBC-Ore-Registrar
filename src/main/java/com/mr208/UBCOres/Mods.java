...
public class Mods {
	...
	{
		String Ores[] = {"galacticraftAluminum","galacticraftCopper","galacticraftSilicion","galacticraftTin"};
		UBCHelper.registerModOresWithMeta("GalacticraftCore","gcBlockCore",5,1,Ores,event);
	}
